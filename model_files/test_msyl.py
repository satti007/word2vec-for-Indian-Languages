...
for s in range(1,51):
	with tf.Session(graph=train_graph) as sess:
		...
		f = np.load('exper_1to4_msyl/weights/weights_{}.npz'.format(s))
	...
	file.write(('{}, rho : {}\n'.format(s,round(100*(scipy.stats.spearmanr(human_score,emb_score)[0]),3))).encode('utf-8'))
...
# for a,t in zip (A,initial_weights):
